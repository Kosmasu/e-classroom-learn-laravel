  ...
  <div class="p-4 flex flex-col">
    ...
    <div>
      <a href="{{ route('admin.home') }}">
        ...
        @if (URL::current() == 'http://127.0.0.1:8000/admin') bg-navy-secondary font-semibold @endif
        ">Home</div>
      </a>
    </div>
    <hr>
    ...
    <div>
      <h1 class="text-lg font-semibold px-1 py-2">Master</h1>
      <div class="pl-2">
        <a href="{{ route('admin.mahasiswa') }}">
          <div class="hover:bg-navy-secondary hover:font-semibold rounded px-1 py-2 pl-2
          @if (URL::current() == 'http://127.0.0.1:8000/admin/mahasiswa') bg-navy-secondary font-semibold @endif
          ">Mahasiswa</div>
        </a>
        <a href="{{ route('admin.dosen') }}">
          <div class="hover:bg-navy-secondary hover:font-semibold rounded px-1 py-2 pl-2
          @if (URL::current() == 'http://127.0.0.1:8000/admin/dosen') bg-navy-secondary font-semibold @endif
          ">Dosen</div>
        </a>
      </div>
    </div>
