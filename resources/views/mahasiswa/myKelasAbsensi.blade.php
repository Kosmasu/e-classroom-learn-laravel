        ...
        <tbody>
          @forelse ($listAbsensi as $key => $absensi)
            <tr class="odd:bg-slate-300 even:bg-slate-200">
              ...
              <td class="px-2 py-1 text-center">{{ $absensi['minggu_ke'] }}</td>
              <td class="px-2 py-1 text-center">{{ $absensi['materi'] }}</td>
              <td class="px-2 py-1 text-center">{{ $absensi['deskripsi'] }}</td>
